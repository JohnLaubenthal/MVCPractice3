...
namespace MVCPractice3.Controllers
{
    ...
    {
        private MVCPractice3Context db = new MVCPractice3Context();
        ...
        public ActionResult Create([Bind(Include = "VirtualPetId,Name,Age,Hunger,Thirst")] VirtualPet virtualPet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VirtualPetId,Name,Age,Hunger,Thirst")] VirtualPet virtualPet)
        {
            if (ModelState.IsValid)
            {
